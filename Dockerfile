...
COPY --chown=$USERID:$GROUPID target/ars-pseudonymization-service.jar /app.jar
...
LABEL de.gematik.vendor="gematik GmbH" \
      ...
      de.gematik.app="ars-pseudonymization-service" \
      de.gematik.git-repo-name="https://gitlab.prod.ccs.gematik.solutions//git/demis/services/ars-pseudonymization-service" \
